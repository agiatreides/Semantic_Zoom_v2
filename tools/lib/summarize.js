 ...
 * Claude mode: calls the local Claude CLI for abstractive reduction.
 *
 * Two entry points:
...
/**
 * Abstractive REDUCTION via the local Claude CLI.
 *
...
EXAMPLES of correct first-mention introductions (generic, not from this work):
  - "my daughter, accused of cheating"       (use narrator's relationship when tighter)
...
REDUCTION ≠ SUMMARY. The output is the SAME story told tighter, in the original voice. The reader is still reading the work, just with flourish and incidental detail cut. Characters still ACT. Decisions still HAPPEN. Dialogue still has weight.
  ...
  WRONG (summary): "The captain faces a command dilemma."
  RIGHT (reduction): The storm hits. The crew begs him to turn back. He refuses.

  WRONG (summary): "The essay argues that incentives shape discovery."
  RIGHT (reduction): Incentives decide what gets searched. What gets searched gets found.
...
- DIALOGUE is LOAD-BEARING. When the source has direct speech in quotation marks, keep load-bearing dialogue VERBATIM. Do NOT convert quoted speech into third-person narration. Quote marks in, quote marks out.
